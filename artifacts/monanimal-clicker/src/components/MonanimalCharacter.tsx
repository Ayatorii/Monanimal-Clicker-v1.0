...
export default function MonanimalCharacter() {
  ...
  return (
    <div ref={containerRef} className="relative w-full h-full overflow-hidden select-none">
      <div
        className={`combo-screen-glow absolute inset-y-0 left-0 z-40 pointer-events-none ${isMobile ? "w-[73px]" : "w-[125px]"}`}
        style={{ background: "linear-gradient(to right, var(--combo-glow-color, transparent), transparent)" }}
      />
      <div
        className={`combo-screen-glow absolute inset-y-0 right-0 z-40 pointer-events-none ${isMobile ? "w-[73px]" : "w-[125px]"}`}
        style={{ background: "linear-gradient(to left, var(--combo-glow-color, transparent), transparent)" }}
      />
      <div
        className={`combo-screen-glow absolute inset-x-0 bottom-0 z-40 pointer-events-none ${isMobile ? "h-[73px]" : "h-[125px]"}`}
        style={{ background: "linear-gradient(to top, var(--combo-glow-color, transparent), transparent)" }}
      />
      ...
      {ownedItems.includes("smartphone") && (
        <motion.div
          className={`absolute z-10 pointer-events-none flex items-center justify-center rounded-full ${isMobile ? "w-[64px] h-[64px]" : "w-[118px] h-[118px]"}`}
          style={{
        ...
        >
          <img src={ITEMS.smartphone} alt="Smartphone" className={`object-contain ${isMobile ? "w-[52px] h-[52px]" : "w-[100px] h-[100px]"}`} style={{ filter: `drop-shadow(0 0 8px ${activeStage.glowColor})` }} />
        </motion.div>
      )}
      {ownedItems.includes("laptop") && (
        ...
        >
          <img src={ITEMS.laptop} alt="Laptop" className={`object-contain ${isMobile ? "w-[52px] h-[52px]" : "w-[100px] h-[100px]"}`} style={{ filter: `drop-shadow(0 0 8px ${activeStage.glowColor})`, transform: isMobile ? undefined : "translateX(-5px) translateY(3px)" }} />
        </motion.div>
      )}
      {ownedItems.includes("gpu") && (
        ...
        >
          <img src={ITEMS.gpu} alt="GPU" className={`object-contain ${isMobile ? "w-[52px] h-[52px]" : "w-[100px] h-[100px]"}`} style={{ filter: `drop-shadow(0 0 8px ${activeStage.glowColor})` }} />
        </motion.div>
      )}
      ...
      {ownedItems.includes("ai_agent") && (
        ...
        >
          <img src={ITEMS.ai_agent} alt="AI Agent" className={`object-contain ${isMobile ? "w-[52px] h-[52px]" : "w-[100px] h-[100px]"}`} style={{ filter: `drop-shadow(0 0 8px ${activeStage.glowColor})`, transform: isMobile ? "translateY(4px)" : "translateY(14px)" }} />
        </motion.div>
      )}
      {ownedItems.includes("validator_node") && (
        ...
        >
          <img src={ITEMS.validator_node} alt="Validator Node" className={`object-contain ${isMobile ? "w-[52px] h-[52px]" : "w-[115px] h-[115px]"}`} style={{ filter: `drop-shadow(0 0 8px ${activeStage.glowColor})` }} />
        </motion.div>
      )}
      {ownedItems.includes("data_center") && (
        ...
        >
          <img src={ITEMS.data_center} alt="Data Center" className={`object-contain ${isMobile ? "w-[52px] h-[52px]" : "w-[100px] h-[100px]"}`} style={{ filter: `drop-shadow(0 0 8px ${activeStage.glowColor})` }} />
        </motion.div>
      )}
          ...
          {currentComboLevel && (
            ...
            >
              <div className="flex items-center gap-2">
                <span
                  className={`tracking-tight leading-none ${isMobile ? "text-[32px]" : "text-[34px]"}`}
                  style={{
                ...
                <span
                  className={`uppercase tracking-widest leading-none ${isMobile ? "text-[21px]" : "text-[23px]"}`}
                  style={{
                    fontFamily: "'Baloo 2', sans-serif",
                    fontWeight: 800,
                    color: "#fff",
          ...
          return (
            <div key={s.key} className="flex flex-col items-center gap-0.5">
              <img
                ...
                alt={s.label}
                className={`object-contain rounded-full ${isMobile ? "w-[27px] h-[27px]" : "w-9 h-9"}`}
                style={{
                  filter: isActive
              ...
              />
              <div
                className={`text-[7px] font-bold tracking-widest uppercase ${isMobile ? "hidden" : "block"}`}
